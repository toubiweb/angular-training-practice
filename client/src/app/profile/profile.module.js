(function () {
    ...
    angular.module('tw.practice.profile', ['ui.router', 'ngResource', 'angular-cache', 'js-data', 'tw.practice.util', 'tw.practice.security', 'validation.match', 'tw.practice.chart']);
